<div class="container mt-3">
    ...
    <div class="row">
        <div class="col-6">
            <button type="button" class="btn btn-dark tombolData" data-bs-toggle="modal" data-bs-target="#formModal">
            Tambah Data Siswa
            </button>
            <br><br>
                ...
                <ul class="list-group">
                    <?php foreach ($data['sws'] as $sws ) :?>
                        <li class="list-group-item  align-item-center">
                            ...
                            <a href="<?= MAINURL;?>/siswa/detail/<?= $sws['id']?>" class="badge bg-dark float-end me-1 tampilSiswa" data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?= $sws['id'];?>">Edit</a>
                            <a href="<?= MAINURL;?>/siswa/hapus/<?= $sws['id']?>" class="badge bg-dark float-end me-1" onclick="return confirm('MAU DIHAPUS AJA NIH? YANG BENER?')">Hapus</a>
                        </li>
                    <?php endforeach ;?>
                </ul>
        </div>
